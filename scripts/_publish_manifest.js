const fs=require('fs');
const sig=fs.readFileSync('src-tauri/target/release/bundle/nsis/DUSTLINE_1.0.6_x64-setup.exe.sig','utf8').trim();
const notes='Multiplayer overhaul: host-only sim, networked combat FX, loadouts/skins/grenades online, hit-location crits, reliable input, strict DUSTLINE lobbies, disconnect + invite cold-start.';
const site='https://website-red-six-83.vercel.app';
const gh='https://github.com/coreystndr/dustline/releases/download/v1.0.6';
const setup='DUSTLINE_1.0.6_x64-setup.exe';
const latest={
  version:'1.0.6',
  notes,
  ...
  history:[
    {version:'1.0.5',notes:'Steam invite friend'},
